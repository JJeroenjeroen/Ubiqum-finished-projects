...
#This file will train models that predict floor and save the results in an RDS file  
...
source(file = "1) Building 1 preprocess.R")
...
remove(x_list_train, x_list_test, 
       y_list_train, Building_1_train, 
       Building_1_test, fitControl)
